...
- **High-resolution shadows, mirrors, and survivor diplays:** The shadow map, reflection, and survivor render textures have had their resolution increased, reducing pixelation. The mirrors have also been changed from 16-bit color to 24-bit to eliminate color-banding. Note that this scales with display resolution, so that low-end platforms like the Steam Deck are not overwhelmed.

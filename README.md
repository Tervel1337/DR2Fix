...
- **High-resolution shadows, mirrors, and survivor diplays:** These have had their resolution increased, reducing pixelation. Note that this scales with display resolution, so that low-end platforms like the Steam Deck are not overwhelmed. The mirrors have also been changed from 16-bit color to 24-bit to eliminate color-banding, and the mirrors and survivor display are now anti-aliased.
